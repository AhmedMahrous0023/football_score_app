...
import 'package:football_score_app/const.dart';
import 'package:football_score_app/models/live_match_model.dart';
import 'package:football_score_app/widgets/live_match_stats.dart';
      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
              ...
              child: Column(
                children: [
                  ...
                  LiveMatchStats(
                    ...
                    awayStats: (100 - widget.liveMatch.possession).toInt(),
                    title: "Possession",
                    homeValue:
            ...
            // LiveMatchDetail(widget:MatchDetailScreen(liveMatch: widget.liveMatch) ),
          ],
        ),
      ),
    );
